...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `bclientesasedprograma` ;
...
CREATE TABLE IF NOT EXISTS `basedprograma`.`encargado` (
  ...
  `codEncar` INT NOT NULL auto_increment,
...
-- select * from restaurante; 
   ...
   insert into clientes 
	( codClien, nomClien, dirClien, numTelClien, numPedido,codRest)
    values
	 (312,'nacho salcedo', 'calle de los santos 3','65699865', 4564,001),
	 (313,'pepe sanchez', 'urb las mimosas 4', '85696541', 4565,001),
	 (314,'juan ortega','calle los melones 3', '6547832', 4566,001),
	 (315,'emilio reyes', 'avenida españa 7', '65693321', 4567,001),
	 (316,'perico palotes', 'calle el agua 3' ,'89674532', 4568,001),
	 (317,'kiko narvaez', 'urba casas del duque 4','15243985', 4569,001),
	 (318,'antonio lucas', 'avenida los reyes catolicos 5','58698745', 4570,001);
