...
public class ControladorCliente {
	...
	public Cliente findByPK(int codClien) {
		...
		this.consulta = em.createNativeQuery("Select * from cliente where codClien = ?", Cliente.class);
	...
	public Cliente findByNif(String nombre) {
		this.em = entityManagerFactory.createEntityManager();
		Cliente aux = null;
		this.consulta = em.createNativeQuery("Select * from cliente where nomClien = ?", Cliente.class);
