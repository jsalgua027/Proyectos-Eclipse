...
public class ControladorRestaurante {
	...
	public Restaurante findByPK(int codRest) {
		this.em = entityManagerFactory.createEntityManager();
		Restaurante aux = null;
		this.consulta = em.createNativeQuery("Select * from restaurante where codRest = ?", Cliente.class);
	...
	public Restaurante findByNif(String nomRest) {
		this.em = entityManagerFactory.createEntityManager();
		Restaurante aux = null;
		this.consulta = em.createNativeQuery("Select * from restaurante where nomRest = ?", Cliente.class);
